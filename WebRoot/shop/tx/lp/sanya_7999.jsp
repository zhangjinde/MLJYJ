    ...
    <head>
        ...
        <script>
            ...
            function addfavorite(){
                ...
                var a = "http://www.jyj.me/shop/tx/lp/sanya_7999.jsp";
                var b = "三亚7999旅拍套餐";
                if (document.all) {
        ...
        <section id="main">
            <div class="container_12">
                <div id="content" class="grid_12">
                    <header>
                        <h1 class="page_title">三亚旅拍7999套餐</h1>
                    </header>
                    <article class="product_page">
                        ...
                        <div class="grid_7">
                            ...
                            <br/>
                            <div class="cart">
                                <form name=alipayment action=alipay/alipayapi.jsp method=post target="_blank" id="alipayment" onsubmit="return buycilck()">
                                    <span class="new-btn-login-sp">
                                        <button class="bay" id="buy" style="text-align:center;">
                                    ...
                                    <dl class="content">
                                        <input name="ordernum" id="ordernum" type="hidden" style="color:red;"/><input name="ordername" value="三亚旅拍7999套餐" type="hidden" /><input name="ordermoney" value="7999" type="hidden" />
                                        </dd>
                                        <div class="username">
                                            <dt>
                                                用户姓名：（必填）
                            ...
                            <div id="wrapper_tab" class="tab1">
                                ...
                                <div class="tab1 tab_body">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                          	拍摄至少160（外100）张，精选50张入册
                                        </li>
                                        <li>
                                            赠送全部拍摄电子档
                                        </li>
                                        <li>
                                            	所选精修照片50张，额外购买精修入册30元/张
                                        </li>
                                        <li>
                                            刻盘赠送
                                        </li>
